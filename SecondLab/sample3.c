...
void MyKeyboardFunc(unsigned char Key, int x, int y)
{
    ...
    {
        case 'r':
            r = 1.0;g = 0.0;b = 0.0;a = 1.0; // Set the clear color to red
            glClearColor(r, g, b, a); // Set the clear color for the window
            glClear(GL_COLOR_BUFFER_BIT); // Clear the color buffer
            glFlush(); // Flush the OpenGL pipeline
            break;
        ...
        case 'g':
            r = 0.0;g = 1.0;b = 0.0;a = 1.0; // Set the clear color to green
            glClearColor(r, g, b, a); // Set the clear color for the window
            glClear(GL_COLOR_BUFFER_BIT); // Clear the color buffer
            glFlush(); // Flush the OpenGL pipeline
            break;
        ...
        case 'y':
            r = 1.0;g = 1.0;b = 0.0;a = 1.0; // Set the clear color to yellow
            glClearColor(r, g, b, a); // Set the clear color for the window
            glClear(GL_COLOR_BUFFER_BIT); // Clear the color buffer
            glFlush(); // Flush the OpenGL pipeline
            break;
